...
public class NeercXMPPConnection implements ChatManager, TaskManager {
	...
	public NeercXMPPConnection() {
		...
		password = SettingsManager.instance().get("hall.chat.xmpp.password", "test");
    ...
    public synchronized void connect() {
        ...
        muc = new MultiUserChat(connection, SettingsManager.instance().get("hall.chat.xmpp.room", "neerc@conference.finomen.kt15.ru"));
	...
	public void newTask(Task task) {
		...
		packet.setTo(SettingsManager.instance().get("hall.chat.xmpp.service", "neerc.finomen.kt15.ru"));
...
//		LOG.debug("parsed " + response.getClass().getName());
    ...
    private class MyPresenceListener implements PacketListener {
        public void processPacket(Packet packet) {
            ...
            if (!from.startsWith(SettingsManager.instance().get("hall.chat.xmpp.room", "neerc@conference.finomen.kt15.ru"))) {
                return;
            }
